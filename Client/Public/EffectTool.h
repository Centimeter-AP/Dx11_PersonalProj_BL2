...
class CEffectTool final : public CImGuiTool
{
private:
...
private:
	...
	CEffectTool(const CEffectTool& Prototype);
...
public:
	static CEffectTool* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg);
