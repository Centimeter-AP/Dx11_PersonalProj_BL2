...
void CSound_Device::Set_Listener_Position(CTransform* pTransform, const _float3& vel)
{
    _float3 vLook = {};
    ...
    _float3 vPos = {};
    XMStoreFloat3(&vPos, XMVector3Normalize(pTransform->Get_State(STATE::POSITION)));
